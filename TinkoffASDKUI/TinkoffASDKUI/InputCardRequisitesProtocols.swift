...
public class CardRequisitesBrandInfo: CardRequisites, CardRequisitesBrandInfoProtocol {
    ...
    private func cardPaymentSystem(pstype: CardType) -> (img: UIImage?, size: CGSize) {
        ...
        case .unrecognized:
            break
        case .mastercard:
            result = UIImage(named: "mc_logo", in: Bundle.tinkoffUI, compatibleWith: nil)
            size = sizeLogoPaymentSystem
        case .visa:
            result = UIImage(named: "visa_logo", in: Bundle.tinkoffUI, compatibleWith: nil)
            size = sizeLogoPaymentSystem
        case .mir:
            result = UIImage(named: "mir_logo", in: Bundle.tinkoffUI, compatibleWith: nil)
            size = sizeLogoPaymentSystem
        case .maestro:
            result = UIImage(named: "maestro_logo", in: Bundle.tinkoffUI, compatibleWith: nil)
            size = sizeLogoPaymentSystem
        }
